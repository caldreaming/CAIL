...
from CailExample import read_squad_examples, convert_examples_to_features, write_predictions_test_ensemble
...
def main():
    ...
    if args.do_test:
        for output_dir in output_dir_list:
            all_preds, all_nbese, test_examples = _test(args, output_dir, device, n_gpu, True)
            all_preds_list.append(all_preds)
            all_nbese_list.append(all_nbese)
