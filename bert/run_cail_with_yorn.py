...
flags.DEFINE_integer("max_steps_without_decrease", 10000,
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        if len(prelim_predictions) > 0:
            ...
            if pred.start_index > 0:  # this is a non-null prediction
                ...
                final_text = get_final_text(tok_text, orig_text, do_lower_case=do_lower_case)
...
def main(_):
    ...
    run_config = tf.estimator.RunConfig(save_checkpoints_steps=FLAGS.save_checkpoints_steps, keep_checkpoint_max=12)
